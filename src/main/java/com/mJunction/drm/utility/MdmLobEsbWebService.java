...
@WebServlet("/mdmLobEsbWebservice")
public class MdmLobEsbWebService extends HttpServlet {
		...
		try {
			...
			while (rs.next()) {
				...
				if (in != null) {
					...
					filePath = generateExcel(xmlDocument);
	...
	public static String generateExcel(File xmlDocument) {
		String filePath = "";
		try {
