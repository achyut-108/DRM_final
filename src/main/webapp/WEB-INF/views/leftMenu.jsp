  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>SADHNA</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="../../index.html"><i class="fa fa-circle-o"></i>Temple Sadhna</a></li>
            <li><a href="../../index2.html"><i class="fa fa-circle-o"></i>Personal Sadhna</a></li>
          </ul>
        </li>
        <!-- <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../../index.html"><i class="fa fa-circle-o"></i>Health History</a></li>
          </ul>
        </li>
                <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i>COM</a></li>
            <li>
              <a href="#"><i class="fa fa-circle-o"></i>BICTE
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-circle-o"></i>PDC Training</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i>Bramhachari Training</a></li>
                <li>
                  <a href="#"><i class="fa fa-circle-o"></i>Sadhna Services
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    <li><a href="#"><i class="fa fa-circle-o"></i>Temple Sadhna</a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i>NA</a></li>
                  </ul>
                </li>
              </ul>
            </li>
