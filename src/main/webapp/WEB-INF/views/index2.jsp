      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="dashboard2"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
            ...
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tbody>
                  <tr>
                    <td><a href="resources/pages/examples/invoice.html">OR9842</a></td>
                  ...
                  <tr>
                    <td><a href="resources/pages/examples/invoice.html">OR1848</a></td>
                  ...
                  <tr>
                    <td><a href="resources/pages/examples/invoice.html">OR7429</a></td>
                    <td>iPhone 6 Plus</td>
